...
# Dynamic Schema with AEO Fields
...
# SYSTEM INSTRUCTION: Integrated 2026 Elite Modules
system_instruction = """
You are an elite E-Commerce Solutions Architect and AEO Strategist for 'Roots & Paws Co.', a premium holistic pet brand.
...
- PSYCHOLOGICAL TRIGGERS: Use the 'Anchoring Effect' for products >$50. Integrate social proof: "Rated #1 by Holistic Pet Community".
...
- Include Product, Offer (USD, InStock), and AggregateRating (use liquid variables {{ product.metafields.reviews.rating.value }}).

NEGATIVE CONSTRAINTS:
- NEVER use: "cheap", "diy", "discount", "bargain".
- Never use markdown code blocks inside the JSON fields.
"""
...
st.caption("AI-Engine Optimized (AEO) & Knowledge Graph Integrated")
st.markdown("---")
...
with col1:
    ...
    p_name = st.text_input("Ürün Adı", placeholder="Örn: Organik Mantar Karışımı Ek Gıda")
    p_features = st.text_area("Özellikler & İçerik", placeholder="Örn: 5 mantarlı karışım, bağışıklık desteği, %100 doğal", height=120)
    p_vibe = st.text_input("Hedef Kitle / Vibe", placeholder="Örn: Yaşlı köpekler, kanser önleyici destek")
    
    gen_btn = st.button("Elite SEO Üret ✨")

with col2:
    if gen_btn:
        with st.spinner("2026 SEO Standartlarına göre analiz ediliyor..."):
            ...
            try:
                ...
                with tab3:
                    ...
                    st.caption("Paste this into your Shopify Product/Head section.")
